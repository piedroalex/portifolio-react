  ...
  return (
    <div className={`${temaEscuro ? 'dark-theme' : ''}`} style={{ minHeight: '100vh' }}>
      ...
      <main>
        ...
        <section id="sobre">
            <h2>Sobre Mim</h2>
            <img src={fotoPerfil} alt="Foto de Pedro Alex" />
            <p>Sou professor de Sistemas para Internet e apaixonado por desenvolvimento web.</p>
        </section>
      ...
      <footer>
        <p>&copy; 2026 - Desenvolvido por Pedro Alex</p>
      </footer>
    </div>
  );
}
